    ...
    <div className="w-full min-h-full my-auto  bg-transparent">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-3 lg:gap-4">
          ...
          <div
            className={`bg-white rounded-lg shadow-lg overflow-hidden transition-all duration-300 ${
              selectedDayEvents || selectedEvent
                ? "lg:w-[calc(100%-24rem)] xl:w-[calc(100%-28rem)]"
                : "w-full"
            }`}
          >
          ...
          {/* Desktop Side Panel */}
          {selectedDayEvents && !selectedEvent && (
            <div className="hidden lg:block lg:w-80 xl:w-96 animate-in slide-in-from-right duration-300">
                  ...
                  {selectedDayEvents.events.map((event) => (
                    ...
                    >
                      ...
                      <div className="space-y-1 text-xs text-gray-600">
                        ...
                        <div className="flex items-center gap-1">
                          <span className="font-medium text-[#500000]">
                            Budget:
                          </span>
          ...
          {selectedEvent && (
            <div className="flex flex-col bg-white shadow-md rounded-lg h-full">
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                <div>
                  <p className="font-medium text-[#500000] mb-1 text-sm">
                    Aligned SDGs
                  </p>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 leading-relaxed">
                    {selectedEvent?.ProposedIndividualActionPlan
                      ?.briefDetails || "No details provided."}
                  </p>
                </div>
