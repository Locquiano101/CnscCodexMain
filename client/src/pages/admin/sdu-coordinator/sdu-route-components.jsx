...
import { SduCoorAccreditationNavigationSubRoute } from "./sdu-coor-main";
import { SduCoorAccreditationMain } from "./individual-accreditation/sdu-coor-accreditation-main";
...
export function SduCoorComponent({
  selectedOrg,
  orgs,
  onSelectOrg,
  loading,
      ...
      <div className="flex-col flex flex-1 h-full ">
        <Routes>
          ...
          <Route
            path="/accreditation/*"
            element={
              <SduCoorAccreditationNavigationSubRoute
          ...
          >
            <Route
              ...
              element={
                selectedOrg ? (
                  <SduCoorAccreditationMain selectedOrg={selectedOrg} />
                ) : (
...
export function SduCoorDashboard({
  organizationSummary,
  orgs,
  onSelectOrg,
  loading,
  ...
  const latestOrgs = useMemo(() => {
    ...
    const timeOf = (o) => new Date(o?.updatedAt || o?.createdAt || 0).getTime();
  ...
  const upcomingActivities = useMemo(() => {
    return latestOrgs
      ...
      .filter(
        (act) =>
          new Date(act?.ProposedIndividualActionPlan?.proposedDate) >
          new Date(),
      )
      .sort(
        (a, b) =>
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900">
            Sdu Coordinator Dashboard
          </h1>
          <p className="text-sm text-gray-600">
            Overview of organizations and activities
          </p>
        </div>
        <LogoutButton />
      </div>
