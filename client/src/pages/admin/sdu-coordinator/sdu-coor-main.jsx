...
// import icons/components you already have (LogoutButton, SduCoorDashboard, etc.)
// import { OrgHome, OrgAccreditation, OrgActivities, OrgFinancial,OrgAccomplishments } from "./SduCoor-org-views";

import { SduCoorDashboard } from "./sdu-route-components";
      ...
      <div className="w-64 flex-shrink-0 bg-background border-r flex flex-col">
        ...
        <div className="h-18 border-b flex items-center px-6 gap-3">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-xs text-muted-foreground">Sdu Coordinator</p>
          </div>
        </div>
        ...
        <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
          {[
            { to: `/SduCoor/${orgAcronym}/home`, label: "Home" },
            {
              to: `/SduCoor/${orgAcronym}/accreditation`,
              label: "Accreditation",
            },
            { to: `/SduCoor/${orgAcronym}/activities`, label: "Proposals" },
            {
              to: `/SduCoor/${orgAcronym}/financial`,
              label: "Financial Statement",
            },
            {
              to: `/SduCoor/${orgAcronym}/accomplishment`,
      ...
      <div className="w-full h-full flex flex-col">
        <Routes>
          <Route
            ...
            element={
              <SduCoorDashboard
                ...
                loading={loading}
                onSelectOrg={(org) =>
                  navigate(`/SduCoor/${org.orgAcronym}/home`)
                }
              />
            }
          />
          ...
          <Route
            path=":orgAcronym/*"
            element={
              <OrgLayout orgs={orgs} onClose={() => navigate("/SduCoor")} />
            }
          />
        </Routes>
      </div>
...
// function SduCoorMainNavigation() {
...
//     if (path === "/SduCoor" || path === "/SduCoor/") {
//       setActiveKey("home");
//     } else if (path.includes("/SduCoor/accreditation")) {
//       setActiveKey("accreditations");
//     } else if (path.includes("/SduCoor/accomplishment")) {
//       setActiveKey("accomplishments");
//     } else if (path.includes("/SduCoor/proposal")) {
//       setActiveKey("proposals");
//     } else if (path.includes("/SduCoor/post")) {
//       setActiveKey("post");
//     } else if (path.includes("/SduCoor/log")) {
//       setActiveKey("logs");
//     }
//   }, [location.pathname]);
...
//       path: "/SduCoor/accreditation",
//     },
//     {
//       key: "accomplishments",
//       icon: <BookMarked className="w-5 h-5" />,
//       label: "Accomplishments",
//       path: "/SduCoor/accomplishment",
//     },
//     {
//       key: "proposals",
//       icon: <FileText className="w-5 h-5" />,
//       label: "Proposals",
//       path: "/SduCoor/proposal",
//     },
...
export function SduCoorAccreditationNavigationSubRoute({ selectedOrg }) {
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      path: `/SduCoor/accreditation/president-information`,
    ...
    },
    {
      ...
      path: `/SduCoor/accreditation/financial-report`,
    ...
    },
    {
      ...
      path: `/SduCoor/accreditation/roster-of-members`,
    ...
    },
    {
      ...
      path: `/SduCoor/accreditation/proposed-action-plan`,
    ...
    },
    {
      ...
      path: `/SduCoor/accreditation/document`,
  ...
  return (
    <div className="flex flex-col h-full w-full overflow-hidden bg-gray-50">
      ...
      ${isDropdownOpen ? "rounded-t-lg" : "rounded-lg"}`}
            ...
            {/* Dropdown Menu */}
            {isDropdownOpen && (
              <div className="absolute w-85 top-full left-0 right-0 rounded-b-lg border border-t-0 border-gray-200 bg-white shadow-lg z-50 overflow-hidden max-w-md">
                <div className="py-1">
                  {navigationItems.map((item) => (
                    <button
                      key={item.key}
